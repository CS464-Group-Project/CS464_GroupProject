    ...
    <>
      ...
      <div className='flex container-fluid mt-4 home-container'>
        <div className='row' id='main-row'>
          ...
          <div className='col' id='event-col'>
            <div className='row' id='inner-main-row'>
              <div className='col-12' id='live-events'>
                <h2>Live Events</h2>
              ...
              <div className='col' id='past-events'>
                <h2>Past Matches</h2>
        ...
        <div className='row' id='second-row'>
          <div className='col-6 chart-content' id='stadium'>
            Stadium Capacity
