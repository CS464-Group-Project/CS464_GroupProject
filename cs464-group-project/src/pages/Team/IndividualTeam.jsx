...
export function IndividualTeam() {
  ...
  */}
        <div className='row' id='main-row'>
          ...
          >
            <div className='row'>
              <div className='col-6 col-sm-2 col-md-2 col-lg-2 col-xl-12'>
                <a
                  className='team-homepage'
                  href={`https://${team.strWebsite}`}
                  target='_blank'
              ...
              <div className='col-12 col-sm-10 d-flex justify-content-evenly social-media-icons'>
                <a
                  href={`https://${team.strTwitter}`}
                  target='_blank'
                  rel='noopener noreferrer'
          ...
          <div className='col-sm-12 col-md-6 col-lg-6 col-xl-4' id='team-info'>
            <div className='row'>
              <div className='col-12 col-lg-12 chart mt-4 '>
                <TeamStats teamID={team.idTeam} />
              </div>
              <div className='col mt-4 p-4' id='team-schedule'>
          ...
          <div className='col-12 col-md-6 col-lg-6 col-xl-4'>
            <div className='row'>
              <div
                className='col-12 col-sm-12 col-md-12 col-lg-12 mt-4 p-4'
                id='team-players'
              >
